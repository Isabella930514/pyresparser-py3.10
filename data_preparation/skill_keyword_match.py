...
analysis_software = ['excel', 'tableau', 'sas', 'spss', 'd3', 'saas', 'pandas', 'numpy', 'scipy', 'sps', 'spotfire',
                     'scikit', 'splunk', 'power', 'h2o']
...
class skill_keyword_match:
    ...
    def exploratory_data_analysis(self):
        ...
        education_df.loc['bachelor', 'Freq'] = education_df.loc['bachelor', 'Freq'] + education_df.loc[
            'undergraduate', 'Freq']
    ...
    def cal_similarity(self, resume_keywords, location=None):
        ...
        num_jobs_return = 5
        similarity = []
        j_info = self.jobs_info_df.loc[self.jobs_info_df['location'] == location].copy() if len(
            location) > 0 else self.jobs_info_df.copy()
